...
The pipeline can use TF-IDF feature vectors as input to an autoencoder neural network. This is a powerful method to extract high-level features from graph data and improve downstream profiling accuracy.
